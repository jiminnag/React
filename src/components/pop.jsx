                ...
                <div className={styles.contents_in}>
                    ...
                    <div className={styles.pop_b1}>
                        <div className={styles.pop_item1}>
                            <img src="https://shoppingcdn.namyangi.com/attach/item/2023/202304/6c205439-e307-4d42-abb8-f099a5617735.png"></img>
                            <h4>테이크핏 퓨어프로틴 신제품 출시! 수분충전 완전 단백질 플랜</h4>
                            <span>2023.05.09 ~ 2023.06.30</span>
                        </div>
                    </div>
                    <div className={styles.pop_b2}>
                        <div className={styles.pop_item2}>
                            <img src="https://shoppingcdn.namyangi.com/attach/item/2023/202302/7a666558-7a70-499d-9b5d-403d548aa6c4.png"></img>
                    ...
                    <div className={styles.pop_b3}>
                        <div className={styles.pop_item3}>
                            <img src="https://shoppingcdn.namyangi.com/attach/item/2023/202301/f51165d8-6e0e-4463-bdaa-da6fa933a895.png"></img>
