                ...
                <div className={styles.footer_bom_in}>
                    <div className={styles.footer_l}>
                        ...
                        <div className={styles.footersns}>
                            ...
                            <img width="36" height="36" src="https://img.icons8.com/ios-filled/50/twitter-circled--v1.png" alt="twitter-circled--v1" />
                            <img width="36" height="36" src="https://img.icons8.com/ios-glyphs/30/instagram-circle.png" alt="instagram-circle" />
